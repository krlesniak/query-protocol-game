  ...
  const handleEditorDidMount: OnMount = (editor, monaco) => {
    ...
    monaco.editor.defineTheme('nexus-graphite', {
      ...
      rules: [
        ...
        { token: 'support.function', foreground: '8B78B8', fontStyle: 'bold' },
        { token: 'support.function.sql', foreground: '8B78B8', fontStyle: 'bold' },
        { token: 'predefined', foreground: '8B78B8' },
        { regex: /count|sum|avg|max|min/i, token: 'support.function' },
