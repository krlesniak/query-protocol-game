  ...
  const handleEditorDidMount: OnMount = (editor, monaco) => {
    ...
    monaco.editor.defineTheme('nexus-graphite', {
      ...
      rules: [
        ...
        { token: 'predefined.sql', foreground: '8978A8', fontStyle: 'bold' },
        { token: 'predefined', foreground: '8978A8', fontStyle: 'bold' },
        { token: 'support.function.sql', foreground: '8978A8', fontStyle: 'bold' },
        { token: 'support.function', foreground: '8978A8', fontStyle: 'bold' },
