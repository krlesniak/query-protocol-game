  ...
  return (
    <div className="fixed inset-0 z-[999] bg-[#030403] text-[#87966f] font-mono overflow-hidden select-none flex flex-col items-center justify-center p-4 sm:p-8">
      ...
      {showSkip && (
        <button 
          onClick={finishIntro} 
          className="absolute top-6 right-6 sm:top-8 sm:right-8 z-[999] px-4 py-2 text-[9px] sm:text-[11px] font-mono tracking-[0.2em] text-[#656a63] hover:text-[#c0c2b9] border border-[#303630] hover:border-[#a3ad82] bg-[#070909]/80 backdrop-blur-sm transition-all uppercase"
        >
          SKIP [ENTER]]
        </button>
      )}
