...
export const OutroCinematic = ({ onComplete }: OutroCinematicProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-[#020202] text-[#1fff0f] font-mono overflow-hidden select-none flex flex-col items-center justify-center">
      ...
      <div className="relative z-20 w-full max-w-4xl h-[500px]">
        <AnimatePresence>
          ...
          {(phase === 1 || phase === 2) && (
            <motion.div 
              ...
              className="absolute inset-0 flex w-full justify-between items-center px-12"
            >
          ...
          {phase === 3 && (
            ...
            >
              <div className="text-3xl tracking-widest text-center text-red-500 font-bold glow-text-red border border-red-500/30 p-8 bg-red-950/20">
                NEXUS_OS<br/><br/>
          ...
          {/* FAZA 5 & 6: Ostateczna wiadomość w absolutnej ciemności */}
          {phase >= 5 && (
            <motion.div 
              key="oracle-message"
              className="absolute inset-0 flex flex-col items-center justify-center gap-12 text-center"
            >
              {phase >= 5 && (
                <motion.div 
