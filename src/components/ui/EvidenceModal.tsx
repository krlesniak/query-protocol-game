      ...
      >
        ...
        {!ev ? (
          ...
          <div className="flex flex-col lg:flex-row h-full min-h-0 overflow-y-auto lg:overflow-hidden">
            ...
            {/* GRAPHICS */}
            <div className="lg:w-3/5 bg-[#0a0d10] border-b lg:border-b-0 lg:border-r border-[var(--border)] relative flex items-center justify-center p-4 min-h-[200px] sm:min-h-[300px] shrink-0">
              ...
              {!imageError ? (
                <img src={ev.imagePath} alt={ev.title} className="max-w-full max-h-[30vh] lg:max-h-full object-contain relative z-10 shadow-2xl border border-white/5" onError={() => setImageError(true)} />
              ) : (
            ...
            {/* DANE */}
            <div className="lg:w-2/5 flex flex-col p-4 sm:p-8 bg-[var(--surface-1)] lg:overflow-y-auto">
              <div className="mb-6 sm:mb-8 shrink-0">
                <h2 className="text-lg sm:text-xl lg:text-2xl font-mono text-white tracking-wide uppercase leading-tight mb-3 sm:mb-4">{ev.title}</h2>
              ...
              <div className="flex-1">
                <h3 className="font-mono text-[10px] sm:text-[11px] tracking-widest text-[var(--text-secondary)] mb-3 sm:mb-4 border-b border-[var(--border)] pb-2">
                  INVESTIGATOR'S NOTES //
                </h3>
                <p className="font-mono text-[11px] sm:text-[13px] text-[#AAB4BE] leading-relaxed whitespace-pre-wrap">
